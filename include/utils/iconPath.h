...
const char *const setPath         = ":icons/connectableset.png";
// TODO: Create select image for the homogeneous set of machines.
const char *const setPathSelected = ":icons/connectableset.png";
